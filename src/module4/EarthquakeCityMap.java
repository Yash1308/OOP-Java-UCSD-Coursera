...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(165,42,42);
		triangle(52,110,57,100,62,110);
		fill(0,0,0);
		text("City Marker",75,105);
		
		fill(255,255,255);
		ellipse(57,125,10,10);
		rect(52,140,10,10);
		fill(0,0,0);
		...
		fill(255,255,0);
		ellipse(65,180,10,10);
		fill(0,0,255);
		ellipse(65,200,10,10);
		fill(255,0,0);
		ellipse(65,220,10,10);
	...
	private void printQuakes() 
	{
		...
		for(Marker cm : countryMarkers)
		{
			int numQuakes=0;String country=" ";
